// Auth.js v5 configuration for payment-user-web.
//
...
// AIC alpha realm's payment-user-web OAuth2 client is provisioned with
...
//   PAYMENT_OIDC_CLIENT_ID     — OAuth2 client ID (payment-user-web)
